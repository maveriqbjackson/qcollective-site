...
(function () {
  ...
  function renderWeb(la) {
    la.innerHTML =
      '<div class="qw-stage"><div class="qw-head"><span class="t">' + esc((window.CUR && window.CUR.state_name) || "Colorado") + ' General Assembly &middot; co-authorship</span><span class="r">hover &middot; click to pin &middot; scroll to zoom</span></div>' +
