...
OUTDIR        = "data"
SCORE_VERSION = "v4"          # bump this to force a full re-score on the next run
...
def score_person(name, role, state_name, primary_bills, co_count):
    ...
    prompt = (
        ...
        "GRADING STANDARD - be discriminating but fair. Use the FULL scale, and make sure the genuine leaders of the session are recognized at the top:\n  80-100  STANDOUT - roughly the top 10% of the chamber. Personally LED (prime-sponsored) multiple substantial bills that became law and clearly advance the pillars. A genuinely productive, high-impact session. Award this to the clear leaders; do NOT withhold it from members who plainly earned it.\n  60-79   Strong - led several meaningful pillar-aligned bills, some enacted.\n  40-59   AVERAGE - where most members land. A few prime sponsorships, modest impact.\n  20-39   Thin - little prime sponsorship; mostly symbolic, narrow, or unrelated bills.\n  0-19    Nothing that advances the pillars.\n\nMost members are average (40-59); do NOT inflate the middle. But the strongest ~10% who led multiple enacted, pillar-advancing bills SHOULD score 80+. Co-sponsoring popular bills is easy and counts for little. Two members with different records must get different scores.\n\n"
